...
import fr.lemet.application.util.AdresseAdapter;
import fr.lemet.application.util.CalculItineraires;
import fr.lemet.application.util.TransportsMetzException;
...
import fr.lemet.transportscommun.util.StringOperation;
