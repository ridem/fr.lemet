...
package fr.lemet.application.services;
...
import fr.lemet.application.activity.widgets.TransportsWidget11;
import fr.lemet.application.activity.widgets.TransportsWidget11Configure;
import fr.lemet.application.activity.widgets.TransportsWidget21;
...
import fr.lemet.application.activity.widgets.TransportsWidgetLowRes;
...
public class UpdateTimeService extends Service {
     ...
     */
    public static final String ACTION_UPDATE = "fr.ybo.application.action.UPDATE";
    ...
    public void onCreate() {
        ...
        pm.setComponentEnabledSetting(new ComponentName("fr.ybo.application", ".services.UpdateTimeService"),
    ...
    private void createNotification(Notification notification) {
        ...
        String descriptionText = getResources().getString(R.string.notifDescriptionText, notification.getTempsAttente());
