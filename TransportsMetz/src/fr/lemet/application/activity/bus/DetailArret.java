...
import fr.lemet.application.adapters.bus.DetailArretAdapter;
...
public class DetailArret extends AbstractDetailArret implements Refreshable {
	 ...
	 * 
	 * @see
	 * AbstractDetailArret#onCreate(android
	 * .os.Bundle)
	 */
	@Override
	 ...
	 * 
	 * @see
	 * AbstractDetailArret#getSecondsToUpdate
	 * ()
	 */
	@Override
